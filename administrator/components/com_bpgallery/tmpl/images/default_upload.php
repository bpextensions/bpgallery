...
?>
<!-- Modal -->
<div id="bpgallery_upload_form" class="modal hide fade" tabindex="-1" role="dialog"
     aria-labelledby="bpgallery_upload_form" aria-hidden="true">
    ...
    <div class="modal-body">
        <div id="bpgallery_upload_container">
            ...
            <p>
                <button class="btn btn-success" id="bpgallery_upload_field_button"><i
                            class="icon-search"></i> <?php echo JText::_('COM_BPGALLERY_IMAGES_BROWSE_BUTTON') ?>
                </button>
            </p>
        </div>
    </div>
    <div class="modal-footer">
        ...
        <div class="pull-left category-selection">
            <?php echo str_ireplace('type="hidden"', 'type="text" class="hidden"',
                $field->renderField(['hiddenLabel' => true])) ?>
        </div>
