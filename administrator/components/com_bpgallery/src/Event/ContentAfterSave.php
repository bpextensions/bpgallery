 ...
 * Example:
 *  new ContentAfterSave('onEventName', ['context' => 'com_example.example', 'subject' => $contentObject, 'params' => $params]);
 */
class ContentAfterSave extends AbstractImmutableEvent
{
     ...
     *
     * @param   Registry|mixed  $value  The value to set
     *
     * @return  Registry
     */
    protected function onSetParams(mixed $value): Registry
    {
